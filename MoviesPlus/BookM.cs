    ...
    public partial class BookM : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (log.username != "" && log.pwd != "" && log.username != null && log.username != String.Empty && log.pwd != null && log.pwd != String.Empty)
            {
                ...
                if (confmt != "")
                {
                    DialogResult dir = MessageBox.Show("Selected Seats Are :" + confmt + ". To confirm Click Yes.", "Warning", MessageBoxButtons.YesNo);
                if (dir == DialogResult.Yes)
                {
                    if ((int.Parse(walletamt.Text) < int.Parse(label2.Text)))
                    {
                        ...
                        if (p.ShowDialog(this) == DialogResult.OK)
                        {
                            ...
                            MessageBox.Show("Thanks for Using MoviePlus , Enjoy Your Movie.");
                    ...
                    else
                    {
                        ...
                        MessageBox.Show("Thanks You for Using MoviePlus , Enjoy Your Movie.");
                        int i = comboBox4.SelectedIndex;
                        comboBox4.SelectedIndex = i - 1;
                        comboBox4.SelectedIndex = i;
                        label2.Text = "0";
                ...
                MessageBox.Show("Please Login/Register First.");
        ...
        private void addwall_Click(object sender, EventArgs e)
        {
            ...
            if (log.username != "" && log.pwd != "" && log.username != null && log.username != String.Empty && log.pwd != null && log.pwd != String.Empty)
            {
                ...
                {
                    MessageBox.Show("Please Enter Amount To Add Into Wallet.");
                }
