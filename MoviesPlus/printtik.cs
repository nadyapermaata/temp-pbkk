...
namespace BookMyshow
{
    class printtik
    {
        ...
        Graphics graphics = e.Graphics;
            ...
            graphics.DrawString("MoviesPlus", new Font("Times new Roman", 50, FontStyle.Bold), new SolidBrush(Color.Black), 250,20 );
            graphics.DrawString(title, new Font("Times new Roman", 16,FontStyle.Bold), new SolidBrush(Color.Black), 300, 205);
            graphics.DrawString("Date : "+ date + "    Time: " + time, new Font("Courier New", 14), new SolidBrush(Color.Black), 300, 227);
            graphics.DrawString(theater, new Font("Courier New", 14), new SolidBrush(Color.Black), 300, 247 );
            graphics.DrawString("Seats : "+ seat, new Font("Courier New", 14), new SolidBrush(Color.Red), 300, 267 );
            graphics.DrawString("Ticket Id : MPTS"+id, new Font("Courier New", 14), new SolidBrush(Color.Black), 300, 287 );
            graphics.DrawString("Total Amount : "+ price + "/-  ", new Font("Courier New", 14), new SolidBrush(Color.Black), 300, 307);
